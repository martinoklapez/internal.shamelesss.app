          ...
          <>
            <div className="overflow-x-auto">
              <div className="min-w-full divide-y divide-gray-200">
                {/* Header */}
                <div className="hidden sm:grid sm:grid-cols-3 gap-4 px-4 py-3 bg-gray-50 text-xs font-semibold text-gray-700 uppercase tracking-wider">
                  <div>Status</div>
                  <div>Reason</div>
                  <div>Created</div>
                </div>
                ...
                {reports.map((report) => (
                  <div
                    key={report.id}
                    className="sm:grid sm:grid-cols-3 gap-4 px-4 py-4 hover:bg-gray-50 cursor-pointer transition-colors"
