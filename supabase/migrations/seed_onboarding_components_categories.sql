...
SELECT * FROM (VALUES
  ...
  ('gender', 'Gender', 'Gender selection. Conversion only.', ARRAY['conversion']::text[], '{}'::jsonb),
  ('push_notification_permission', 'Push Notification Permission', 'Push permission (simplified in quiz, full in conversion).', ARRAY['conversion']::text[], '{}'::jsonb),
